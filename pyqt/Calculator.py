...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.fulldel = QPushButton('//', self)
        self.fulldel.resize(50, 50)
        self.fulldel.move(225, 155)
        ...
        self.fulldel.clicked.connect(self.fulldel_1)
